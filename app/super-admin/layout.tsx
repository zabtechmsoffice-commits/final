      ...
      <div className="border-b border-sidebar-border/60 bg-gradient-to-b from-sidebar-primary/8 to-sidebar px-6 py-6">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-amber-500/15 text-amber-600 dark:text-amber-400">
            ...
            return (
              ...
              >
                ...
                {typeof badgeValue === "number" ? (
                  <Badge
                    variant="secondary"
                    className="h-5 min-w-5 shrink-0 rounded-full bg-amber-500/20 px-1.5 text-xs font-semibold text-amber-700 dark:text-amber-300"
                  >
                    {badgeValue}
                  </Badge>
                ) : null}
